        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-12 md:grid-cols-3">
            <div className="flex flex-col items-center text-center p-6 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary font-headline">Discover Local Talent</h3>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary font-headline">Place Orders Easily</h3>
              <p className="text-foreground/70">
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-2 text-primary font-headline">Track Your Stitch</h3>
              <p className="text-foreground/70">
